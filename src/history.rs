...
pub type History<R: Resource> = DashMap<u64, R, PassThroughHashBuilder>;

trait AsyncMap<R: Resource> {
...
impl Hasher for PassThroughHasher {
    ...
    fn write_u8(&mut self, _i: u8) { unreachable!() }
    fn write_u16(&mut self, _i: u16) { unreachable!() }
    fn write_u32(&mut self, _i: u32) { unreachable!() }

    fn write_u64(&mut self, i: u64) {
        self.0 = i;
    }

    fn write_usize(&mut self, _i: usize) { unreachable!() }
}
